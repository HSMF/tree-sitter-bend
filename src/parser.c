...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 5:
      if (('\t' <= lookahead && lookahead <= '\r') ||
          lookahead == ' ') SKIP(5);
      if (set_contains(sym_identifier_character_set_1, 656, lookahead)) ADVANCE(7);
      END_STATE();
    case 6:
    ...
    case 7:
      ...
      if (set_contains(sym_identifier_character_set_2, 763, lookahead)) ADVANCE(7);
      END_STATE();
    case 8:
      ACCEPT_TOKEN(anon_sym_def);
      END_STATE();
    case 9:
      ACCEPT_TOKEN(anon_sym_bye);
      END_STATE();
    default:
      return false;
  }
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item, 1, 0, 0),
  [16] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_function_def, 7, 0, 0),
